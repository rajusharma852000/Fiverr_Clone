export const HOST = https://fiverr-clone-backend-plum.vercel.app;
...
export const DASHBOARD_DATA_ROUTES = `${API_URL}/dashbaord`;
...
export const DELETE_GIG_ROUTE = `${GIG_ROUTES}/delete`
